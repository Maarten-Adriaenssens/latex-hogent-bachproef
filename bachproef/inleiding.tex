...
Het beoogde resultaat van deze bachelorproef zijn 2 \gls{poc}'s. Deze bestaan uit een simulatie en een omzetting va nde simulatie naar praktische realisatie. De criteria voor succes zijn de minimum requirements, zie hoofdstuk~\ref{ch:minreq} en hoofdstuk~\ref{ch:minReq}.
